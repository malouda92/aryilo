...
class appProdProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Lm-wfBC0LG', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : ($this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('OtXT2RjzpSpsbpk428CPmYdbUxioCpuuu5KGPjIZvmvopVuBZrxrttMshMUku9RA'))) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('OtXT2RjzpSpsbpk428CPmYdbUxioCpuuu5KGPjIZvmvopVuBZrxrttMshMUku9RA');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.secret' => 'OtXT2RjzpSpsbpk428CPmYdbUxioCpuuu5KGPjIZvmvopVuBZrxrttMshMUku9RA',
